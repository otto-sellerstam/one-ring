...
test-cov:
    uv run pytest --cov=one-ring-core/src/one_ring_core --cov=one-ring-loop/src/one_ring_loop --cov=one-ring-http/src/one_ring_http --cov-report=term-missing --cov-report=html

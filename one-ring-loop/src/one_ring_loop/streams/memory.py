...
# TODO: Implement rendezvous streams
# 1. Create an ABC for the send and receive streams
# 2. Create private subclasses, one pair for buffered and one pair for rendezvous
# 3. Implement rendezvous using a handoff deque and Events
# 4. Type returns from create_memory_object_stream using ABCs
# 5. Profit
